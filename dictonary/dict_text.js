export const dictText = {
    "EN(UK)": {
        ...
        "dnd-campaign-socialEncounters-link" : "Social encounters",
        "dnd-campaign-socialEncounters-desc" : "A document explaining how social encounters in DND 5E work 'under-the-hood.'",
        "dnd-depCampaign-title" : "Campaign-dependent documents",
        "dnd-depCampaign-desc" : "<em>These documents may not apply to all campaigns or sessions which I GM, as the documents may be setting-specific. Ask me if it is unclear whether or not we use any of these documents.</em>",
        "dnd-depCampaign-strongholds-link" : "Strongholds",
        "dnd-depCampaign-strongholds-desc" : "<em>For any campaign set in the Forgotten Realms.</em> The document talks about how to acquire a base, home or stronghold, and gives some options for improving an existing base or stronghold.",
